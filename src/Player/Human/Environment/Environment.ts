...
} from "@/Player/Human/Environment/timeOfDay";
import { defaultMonth, getBlendedSeasonPalette } from "@/Player/Human/Environment/season";
import {
  defaultWeatherType,
  weatherPresets,
  WeatherType,
} from "@/Player/Human/Environment/weather";
import {
  clockHoursPerRealMinute,
  isClockRunning,
  timeOfDay2400,
  wrapTime2400,
} from "@/Player/Human/Environment/clock";
import { EngineSettings } from "@/Player/Human/EngineSettings";
