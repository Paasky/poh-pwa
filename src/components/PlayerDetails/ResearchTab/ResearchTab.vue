...
<template>
  <div
    class="mt-28 m-4 relative text-sm"
    :style="{
  ...
  >
    ...
    <UiHeader
      v-for="(era, i) of objects.getClassTypes('eraType')"
      :key="era.key"
      class="absolute"
    ...
    >
      ...
      <div
        class="text-xs flex flex-wrap items-start content-start gap-x-1 overflow-y-auto"
