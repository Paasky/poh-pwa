...
const currentCategory = computed(() =>
  current.value?.category
    ? objects.getCategoryObject(current.value.category)
    : null,
);
...
<template>
  ...
  >
    ...
    <div class="select-none">
      ...
      <div
        v-if="current.upgradesFrom.length"
        class="mt-4"
      >
        <h3>Upgrades From</h3>
      ...
      <div
        v-if="current.upgradesTo.length"
        class="mt-4"
      >
        <h3>Upgrades To</h3>
