...
const baseClasses = 'inline-flex items-center h-6 justify-center px-1 py-0.5 rounded-md text-slate-100 border-yellow-600 select-none whitespace-nowrap transition-all duration-0 hover:duration-300 cursor-pointer disabled:bg-neutral-700 disabled:border-neutral-600 disabled:cursor-not-allowed' +
