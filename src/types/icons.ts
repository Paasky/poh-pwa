...
const categoryKeys: Record<string, ObjectIcon> = {
  ...
  'buildingCategory:resourceProduction': { icon: faIndustry, color: colors.default },
  ...
  // National wonders
  'nationalWonderCategory:culture': { icon: faMasksTheater, color: colors.culture },
  ...
  'nationalWonderCategory:growth': { icon: faSeedling, color: colors.happiness },
  'nationalWonderCategory:happiness': { icon: faFaceSmile, color: colors.happiness },
  'nationalWonderCategory:health': { icon: faHeart, color: colors.default },
  'nationalWonderCategory:influence': { icon: faScroll, color: colors.influence },
  ...
  'nationalWonderCategory:production': { icon: faHammer, color: colors.default },
  ...
  // Natural wonders
  'naturalWonderCategory:canyon': { icon: faMountainSun, color: colors.default },
  ...
  'naturalWonderCategory:volcano': { icon: faMountainSun, color: colors.default },
  ...
  // World wonders
  'worldWonderCategory:culture': { icon: faMasksTheater, color: colors.culture },
  ...
  'worldWonderCategory:happiness': { icon: faFaceSmile, color: colors.happiness },
...
const keys: Record<string, ObjectIcon> = {
  ...
  'yieldType:goalPoints': { icon: faStar, color: colors.default },
  ...
  'yieldType:intercept': { icon: faPlaneCircleExclamation, color: colors.military },
  'yieldType:missileSlot': { icon: faInbox, color: colors.military },
  'yieldType:moveCost': { icon: faRoad, color: colors.danger },
...
function getIcon (key: string, conceptKey: string | null | undefined = null, categoryKey: string | null | undefined = null): ObjectIcon {
  if (key && key in keys) {
    return keys[key]
  }
